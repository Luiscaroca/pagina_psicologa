                ...
                <div class="container">
                    ...
                    <div class="col-md-6">
                        <div class="left-content">
                            <h3><strong>Puedes contactarme directamente:</strong></h3>
                            </br>
                            <form action="mailto:mjcaroca.araya@gmail.com?subject=Contacto vía página web" method="post" enctype="text/plain">
                                <li>
                                    <label>Nombre:</label>
                    ...
                    <div class="col-md-6">
                        <div class="right-content">
                            <h3><strong>También puedes ver mis datos de contacto:</strong></h3>
                            </br>
                            <div class="float">
